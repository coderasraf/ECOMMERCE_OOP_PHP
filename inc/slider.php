		...
		<div class="header_bottom_left">
			<div class="section group">
				<?php 
					...
					if ($getIphone) {
						$row = $getIphone->fetch_assoc();
					}
				 ?>
				<div class="listview_1_of_2 images_1_of_2">
					<div class="listimg listimg_2_of_1">
						 <a href="preview.html"> <img src="admin/<?= $row['image']; ?>" alt="" /></a>
					</div>
				    <div class="text list_2_of_1">
						<h2><?= $row['brandName']; ?></h2>
						<p><?= $fm->textShorten($row['body'],50); ?></p>
						<div class="button"><span><a href="details.php?productId=<?= $row['productId']; ?>">Add to cart</a></span></div>
				   </div>
			   </div>	
				<div class="listview_1_of_2 images_1_of_2">
					<div class="listimg listimg_2_of_1">
